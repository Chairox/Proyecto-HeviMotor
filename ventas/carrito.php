            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($repuestos as $repuesto) {
                        $total += $repuesto->precio_repuesto;
                    ?>
                        <tr>
                            <td><?php echo $repuesto->nombre_repuesto ?></td>
                            <td><?php echo $repuesto->descripcion_repuesto ?></td>
                            <td>$<?php echo number_format($repuesto->precio_repuesto, 2) ?></td>
                            <td>
